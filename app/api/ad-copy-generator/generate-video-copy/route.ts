...
import { generateVideoAdCopy, AdCopyGeneratorError, AD_ANGLES, type VideoAnalysis, type VideoAdCopyInput } from '@/lib/ad-copy-generator';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { analysis, product_name, selling_price, original_price, target_audience, language, ad_objective, ad_angle, offer, extra_instruction } = body;
