...
export async function GET(req: NextRequest) {
  ...
  // Employee 201 File "Payslip History" tab — explicit employee_id lookup,
  // admin/payroll-permission only. Same generated-payslips-only filter as
  // the self-service path below, since a payslip that hasn't been
  // generated yet isn't a payslip an HR user should be able to open here.
