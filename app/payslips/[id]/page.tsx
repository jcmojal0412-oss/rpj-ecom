        ...
        <div className="payslip-doc">
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '11px', marginBottom: '16px' }}>
            ...
            <tbody>
              ...
              {entry.sss_ee_contribution > 0 && <tr><td style={{ padding: '5px 8px', border: '1px solid #eee' }}>SSS</td><td style={{ textAlign: 'right', padding: '5px 8px', border: '1px solid #eee' }}>{formatCurrency(entry.sss_ee_contribution)}</td></tr>}
              {entry.philhealth_ee_contribution > 0 && <tr><td style={{ padding: '5px 8px', border: '1px solid #eee' }}>PhilHealth</td><td style={{ textAlign: 'right', padding: '5px 8px', border: '1px solid #eee' }}>{formatCurrency(entry.philhealth_ee_contribution)}</td></tr>}
              {entry.pagibig_ee_contribution > 0 && <tr><td style={{ padding: '5px 8px', border: '1px solid #eee' }}>Pag-IBIG</td><td style={{ textAlign: 'right', padding: '5px 8px', border: '1px solid #eee' }}>{formatCurrency(entry.pagibig_ee_contribution)}</td></tr>}
