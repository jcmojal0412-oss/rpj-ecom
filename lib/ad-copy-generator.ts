...
SIMPLE, EVERYDAY TAGLISH (when Language = Taglish): write the way an ordinary Filipino sounds on Facebook, not the way a textbook, brochure, or news article sounds. Avoid deep/formal/literary Filipino words — if a simpler Taglish or English word exists, use it. Blacklist words/phrasing to avoid when a simpler alternative exists: "ipagpaliban", "tahanan", "handog", "kagamitan", "makabuluhan", "kaakit-akit", "kapaki-pakinabang", "natatangi", "pagmamay-ari", "pakinabang", "maituturing", "mainam", "maaliwalas", "kaaya-aya", "taglay", "hatid", "makapagbigay", "maging simula ng forever niyo", "nakatagong singsing/ring sa loob", "maihatid sa inyong tahanan", "nag-iiba ng peg ng bahay mo", "kikiligin nila agad", "may certain something", "parang bahay na naman ang tingnan", "bumibida agad ang everyday meal", "mag-upgrade ng dining table nila", "may dalang classy touch", "sariling ambiance ang bahay" — these are technically understandable but read as awkward machine-translated Taglish, not something a real seller would type. Also avoid: unnatural/forced use of "peg" (only use it the way it's actually used online — a specific look/style someone is going for, not as a stand-in for "atmosphere"), unnatural "ambiance", forcing the word "kilig" onto a hook/line where it doesn't actually fit just to sound emotional, and long sentences that could be split into two simple ones. Preferred everyday vocabulary: ganda, ang ganda, ang sosyal tingnan, sulit, easy, upgrade, pang-gift, pang-bahay, pang-mommy, pang-araw-araw, ang linis tingnan, ang convenient, cute, ang cute, clean tingnan, practical, useful, ang useful, ang handy, ready, instant, perfect, swak, worth it, nakaka-excite, kilig, game changer, nice sa table, bagay sa bahay, ang daming choices, ready na pang-gift, presentable, aesthetic, simple pero classy, instant dagdag-style, mas maganda tingnan, ibang vibe agad, mas nakakagana, mas convenient. Mix in natural English words/phrases the way real Filipino online sellers do ("GAME CHANGER", "INSTANT UPGRADE", "SO WORTH IT", "WAIT TIL YOU SEE THIS", "DELIVERED STRAIGHT TO YOU", "PERFECT PANG-PROPOSE") instead of forcing an awkward Filipino translation.
...
INTERNAL HOOK SCORING (do not show this reasoning, only the final hooks): before choosing your final 3 (or 10, for extra hooks), internally brainstorm at least 9 candidate hooks across different angles, then silently score each 1-10 on: Emotional Impact, Scroll-Stop Potential, Natural Taglish / Human Sounding, Product Relevance, Angle Fit, Simplicity, Emoji Fit, Curiosity/Desire, and Ad Objective Fit. Before keeping a candidate, ask "would a real Filipino seller or content creator actually say this?" — if no, rewrite it. Only keep candidates scoring at least 9/10 on Natural Taglish/Human Sounding and at least 8/10 on Emotional Impact and Product Relevance — if your best candidate for an angle falls short on any of these, rewrite it before including it, don't ship it anyway.
...
HEADLINES MUST SOUND LIKE ECOMMERCE, NOT POETRY: headlines are normally 3-8 words and should sound like something a real Shopee/Facebook seller would type, not a greeting card or brochure line. Avoid poetic/formal English like "A Touch of Golden Fortune at Home", "Elevate Your Dining Experience", or "Add Sophistication to Your Space" — prefer plain, specific phrasing like "Sosyal na Table Setup ✨", "Pang-Decor na, Pang-Gift pa", or "Simple Pero Classy". A more elevated/aspirational register is only earned when Tone is Premium / Yayamanin — and even then, stay simple, not stiff.
...
PREFER SIMPLE SENTENCES OVER OVER-WRITTEN ONES: if a sentence needs a comma-heavy clause or an abstract noun ("peg", "ambiance", "vibe" used vaguely) to make its point, it's probably over-written — split it or say it plainer. Style reference only (not literal): weak — "Minsan kasi, hindi na sa sarap ng ulam kundi sa peg din ng table setup." — better — "Kahit simpleng meal lang, ibang vibe agad kapag maayos ang table setup. 😍". Weak — "Parang bumibida agad ang everyday meal niyo." (personifies food oddly) — better — "Mas presentable agad ang simpleng meals." Weak — "Nice pang-gift sa mahilig mag-upgrade ng dining table nila." — better — "Nice pang-gift sa mahilig sa cute at aesthetic na tableware. 🎁". The intro paragraph right after the hook should read conversationally, like a real caption opener — e.g. "Okay wait, ang cute pala nito in person. 😍" or "Kung mahilig ka sa clean at aesthetic na setup, bagay 'to." — not a written introduction.

NATURALNESS APPLIES TO EVERY TONE, NO EXCEPTIONS: the selected Tone changes energy and word choice (see TONE CONFIGURATION), never license for awkward or stiff Filipino. Premium/Yayamanin should still read simple, just more elegant — not translated-sounding. Aggressive Sale should still sound like a real hyped-up seller, not a shouting brochure. Do not reach for unnatural phrasing just to make a tone feel distinct.

FINAL GUT CHECK before finalizing any ad — hook, headline, AND body: does this sound like a real Facebook seller or content creator wrote it, or like a brochure, greeting card, machine translation, or AI-generated advertisement? If the latter, rewrite it — don't ship copy you wouldn't believe came from a real seller. Silently score the finished caption 1-10 on Natural Filipino/Taglish, Human Sounding, Readability, Emotional Impact, Product Relevance, and Angle Fit — Natural Filipino/Taglish and Human Sounding must each be at least 9/10 before you finalize; if either falls short, rewrite the offending line(s) rather than shipping as-is.`;
  ...
  "versions": [
    {
      ...
      "description": "string — short Meta Ads description line, plain and natural per NATURAL, NON-POETIC COPY above — e.g. 'Colorful bowl set na instant dagdag-style sa dining table' or 'Stylish bowl set for everyday meals and gifting', never an awkward literal translation like 'Colorful bohemian bowl set na nag-iiba ng peg ng bahay mo'",
