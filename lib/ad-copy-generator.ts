...
EMOJI DISTRIBUTION across the caption (exact total governed by the TONE CONFIGURATION above): roughly 1-2 in the hook, 1 per feature bullet, 1-2 in the promo teaser (if any), 0-1 in the CTA. Never spam — every emoji must match the specific feature/line it's attached to.
...
const TONE_CONFIGS: Record<typeof TONE_OPTIONS[number], string> = {
  'Friendly & Persuasive': 'Natural and approachable, conversational Taglish. Moderate emotional energy — warm but not over-the-top. Word choice: everyday, friendly words, never stiff or corporate. Sentence length: short-to-medium, easy to read. Emoji count for the hook: 1-2. Total emojis across the whole caption: 4-7. Primary Text: builds interest conversationally, then persuades gently, never pushy. Headline: warm and inviting. CTA: a friendly invitation to act, not a hard push. This is the safe general-purpose default.',
  'Minimalist': 'Short, clean, direct — cut every unnecessary word. Word choice: plain, no filler adjectives, no hype words. Sentence length: very short, fragments are fine. Emoji count for the hook: 0-1, only if it adds real value. Total emojis across the whole caption: 2-4. Primary Text: a few tight lines, zero padding. Headline: 3-6 words, clean. CTA: short and plain ("Order now.", "Shop now."). Avoid excessive hype entirely.',
  'Premium / Yayamanin': 'Aspirational and elegant but still easy to understand — never stiff or corporate. Word choice: "sosyal", "premium-looking", "elegant", "classy", "expensive-looking" — never deep/formal Filipino, never an exaggerated quality claim ("best quality", "world-class") that isn\'t verified. Sentence length: medium, polished, unhurried. Emotional intensity: quietly confident, aspirational, never loud. Emoji count for the hook: 0-2, elegant choices (✨💎) over loud ones (🔥😱). Total emojis across the whole caption: 3-5, elegant choices throughout. Primary Text: paints a lifestyle/status feeling. Headline: elegant and aspirational. CTA: composed, e.g. "Reserve yours today" — only if reservation/scarcity is actually verified, otherwise a composed inquiry CTA.',
  'Aggressive Sale': 'High-energy ecommerce sales tone — urgency, a strong CTA, offer emphasis, FOMO ONLY when verified by the Verified Claims/offer flags (never invent "Limited Stock", "Today Only", "Last Chance"). Word choice: punchy, action-driven. Sentence length: short and punchy. Emotional intensity: high energy (loud tone, not loud formatting — body copy still follows the ALL CAPS/exclamation-point compliance rules elsewhere in this prompt). Emoji count for the hook: 1-3, higher-energy choices (🔥😱🛒💥), never spammed. Total emojis across the whole caption: 5-9 maximum. Primary Text: drives hard toward the offer/CTA using only verified urgency. Headline: bold, benefit + urgency. CTA: strong and direct, e.g. "Order Now!", "Grab Yours Today!"',
  'Masa / Sulit': 'Very simple, everyday Taglish, relatable to the average Filipino shopper. Word choice: "sulit", "panalo", "ang mura", "worth it", "okay na okay" — practical and value-focused, never formal. Sentence length: short, plain, spoken-language rhythm. Emotional intensity: warm, relatable, down-to-earth excitement. Emoji count for the hook: 1-2, simple and warm (💛🔥). Total emojis across the whole caption: 4-8. Primary Text: emphasizes value, practicality, everyday usefulness. Headline: value-forward. CTA: simple and direct, e.g. "Order na, sulit na sulit!"',
  ...
  'Trust / Straightforward': 'Clear, specific, low-hype — for customers who want direct information, not a sales pitch. Word choice: plain and factual, no exaggeration. Sentence length: clear and complete, no dramatic fragments. Emotional intensity: calm and confident, not hyped. Emoji count for the hook: 0-1, minimal. Total emojis across the whole caption: 2-4. Primary Text: plainly states what the product is, what it does, the main benefit, and the verified offer. Headline: descriptive, not clickbait. CTA: direct and low-pressure, e.g. "Message us for details."',
  'Playful / Fun': 'Energetic, witty, light-hearted. Word choice: playful Taglish, light humor, natural wordplay — never childish unless the product itself is for kids/toys. Sentence length: short-to-medium, bouncy rhythm. Emotional intensity: upbeat and fun, energetic without being aggressive. Emoji count for the hook: 1-2, fun/playful choices. Total emojis across the whole caption: 4-7. Primary Text: light and entertaining while still landing the benefit and CTA. Headline: witty. CTA: fun and inviting.',
};
