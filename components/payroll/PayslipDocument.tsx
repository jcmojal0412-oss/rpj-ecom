...
// The printable payslip itself, shared by the full page (/payslips/[id]) and
// the pop-up on the Payslips page so the two can never drift apart. It only
// draws the document: the page adds its own toolbar / A4 sheet / print rules.
export default function PayslipDocument({ entry, adjustments }: { entry: any; adjustments: any[] }) {
